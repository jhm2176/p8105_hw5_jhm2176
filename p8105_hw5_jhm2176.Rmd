...
This code creates i) a plot showing the average estimate of μ̂  on the y axis and the true value of μ on the x axis and ii) a plot (or overlay on the first) showing the average estimate of μ̂ on the y axis and the true value of μ on the x axis only for samples for which the null was rejected .
