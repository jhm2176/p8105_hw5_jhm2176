...
baltimore = prop.test(x = 1825, n = 2827, conf.level = 0.95, correct = FALSE) %>% broom::tidy()
```
...
```{r}
prop_test_fx = function(city_state) {
  
  test = prop.test(x = n_unsolved_homicides, n = n_homicides, conf.level = 0.95, correct = FALSE)
  test
  
}

prop_test_fx("Baltimore, MD")
